...
\begin{tikzpicture}[auto]
	...
	\node [box, above of=repvec,fill=gray!50](dense){Generative Layer};
	\coordinate [above of=dense, node distance=3em](in);
	\node at (in.north)[above, node distance=0 and 0](testo_in){Pseudo-Random Seed};	
