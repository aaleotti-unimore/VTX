...
Un \textit{autoencoder} tipicamente consiste in due macro-componenti:
\begin{itemize}
...
Di seguito vengono illustrati in dettaglio le principali componenti che compongono l'\textit{autoencoder}.

\begin{figure}[htb]
    \centering
	\input{sections/autoencoder_structure}
...
\subsubsection{Rete Neurale Convoluzionale}

\subsubsection{Long Short Term Machine}
