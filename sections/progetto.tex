...
\begin{figure}[htb]
    ...
    \caption{Grafico del modello intermedio. Escluso il primo layer di input, si notino gli \textit{hidden layer} dense2 e dense3 di dimensioni rispettivamente 128 e 64 }
\label{fig:pieraz}
\end{figure}
