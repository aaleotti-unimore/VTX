...
\begin{tikzpicture}[auto]
    ...
    \coordinate[above of=emb, node distance=7em](begin_enc);
    ...
    \node [box, above of=LSTM2] (cnn2) {Convolutional Layers};
    \begin{scope}[on background layer]
    ...
    \node[container, fit=(emb) (LSTM)] (encoder) {};
